...
drop policy if exists property_types_select
on kiraya.property_types;

drop policy if exists property_types_insert
on kiraya.property_types;

drop policy if exists property_types_update
on kiraya.property_types;
...
drop policy if exists unit_types_select
on kiraya.unit_types;

drop policy if exists unit_types_insert
on kiraya.unit_types;

drop policy if exists unit_types_update
on kiraya.unit_types;
